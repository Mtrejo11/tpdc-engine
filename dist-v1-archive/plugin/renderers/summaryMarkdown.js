...
exports.renderSummaryMarkdown = renderSummaryMarkdown;
function renderSummaryMarkdown(run) {
    ...
    if (run.findings && run.findings.length > 0) {
        ...
        if (run.mutation) {
            const mutationFindings = run.findings.filter((f) => ["patch_grounding", "apply_integrity", "git_traceability", "workflow_inconsistency", "status_mismatch"].includes(f.category));
...
//# sourceMappingURL=summaryMarkdown.js.map