...
exports.renderDiscoveryResult = renderDiscoveryResult;
exports.renderDiscoveryMarkdown = renderDiscoveryMarkdown;
function renderDiscoveryResult(artifact, run) {
    const lines = [];
 ...
 */
function renderDiscoveryMarkdown(artifact, run) {
    const lines = [];
    ...
    if (artifact.impactAreas.length > 0) {
        lines.push("## Impact Areas");
        lines.push("");
        for (const a of artifact.impactAreas)
            lines.push(`- ${a}`);
        lines.push("");
    }
    if (artifact.constraints.length > 0) {
    ...
    if (artifact.tradeoffs.length > 0) {
        ...
        for (const t of artifact.tradeoffs) {
            ...
            if (t.advantages.length > 0) {
                ...
                for (const a of t.advantages)
                    lines.push(`- ${a}`);
            }
            if (t.disadvantages.length > 0) {
                lines.push("");
                lines.push("**Disadvantages:**");
                for (const d of t.disadvantages)
                    lines.push(`- ${d}`);
            }
            lines.push("");
        }
...
//# sourceMappingURL=discoveryRenderer.js.map