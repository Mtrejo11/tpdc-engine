...
const COMMAND_PATTERNS: Array<[RegExp, PlanExecutionCommand]> = [
...
export function normalizePlan(raw: string): PlanContext {
  let likelyCommand: PlanExecutionCommand = "solve";
