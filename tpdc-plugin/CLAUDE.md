...
> **Status:** v0.3.0-alpha.2 (pivot in progress to Claude Code plugin + MCP server). The source of truth for architecture is `~/Documents/Claude/Projects/TPDC/VISION.md` in the source repo.
...
| Stage | Form | Notes |
|---|---|---|
| Execute | MCP tool | Autonomous bash + text_editor loop in a git worktree. |
